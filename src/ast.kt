...
data class Return(val scope:String, val value: String, val isNumber: Boolean) : ASTNode()

// a Node for exit-expressions like exit(x : Int) or exit(42)
data class Exit(val scope:String, val value: String, val isNumber: Boolean) : ASTNode()
...
data class FunctionCall(val name: String, val scope:String, val value: String, val isNumber: Boolean) : ASTNode()
